...
class Vegetable {
    ...
    init(name: String, numberOfCalories: String, urlLabel: String, imageVegeteable: String) {
        self.name = name
        self.numberOfCalories = numberOfCalories
        self.urlLabel = urlLabel
        self.imageVegeteable = imageVegeteable
    }
...
let cabbage = Vegetable(name: "Cabbage", numberOfCalories: "47 cal. / 100 gr.", urlLabel: "http://google.com", imageVegeteable: "cabbage")
